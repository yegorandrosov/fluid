    ...
    public sealed class LowerThanBinaryExpression : BinaryExpression, ISourceable
    {
        ...
        public void WriteTo(SourceGenerationContext context)
        {
            ...
            using (context.Indent())
            {
                ...
                using (context.Indent())
                {
                    RelationalComparison.WriteMismatch(context, "comparison of Integer with String failed");
                }
                context.WriteLine("}");
            ...
            using (context.Indent())
            {
                ...
                using (context.Indent())
                {
                    RelationalComparison.WriteMismatch(context, "comparison of String with Integer failed");
                }
                context.WriteLine("}");
